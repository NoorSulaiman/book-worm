...
import { Form, Button, Grid, Image, Segment, Icon } from 'semantic-ui-react';
...
class BookForm extends React.Component {
    ...
    changeCoverForward = () => {
        ...
        const newIndex = index + 1 >= covers.length ? covers.length - 1 : index + 1;
        this.setState({
            index: newIndex,
    ...
    render() {
        ...
        const firstIconStyle = { outline: 'none', marginLeft: '6%' }
        const secondIconStyle = { outline: 'none', marginLeft: '6%' }
                        ...
                        <Grid.Row>
                            ...
                            <Grid.Column>
                                ...
                                {this.state.covers.length > 1 && (
                                    <div>
                                        <a style={firstIconStyle} role="button" tabIndex={0} onClick={this.changeCoverBack}>
                                            <Icon name="arrow circle left" size="large" />

                                        </a>
                                        <a style={secondIconStyle} role="button" tabIndex={0} onClick={this.changeCoverForward}>
